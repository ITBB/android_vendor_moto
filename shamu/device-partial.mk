...
PRODUCT_COPY_FILES := \
    ...
    vendor/moto/shamu/proprietary/voice-call-min-log.cfg:system/etc/diag/voice-call-min-log.cfg:moto \
    ...
    vendor/moto/shamu/proprietary/com.android.omadm.service.xml:system/etc/permissions/com.android.omadm.service.xml:moto \
    ...
    vendor/moto/shamu/proprietary/com.motorola.ims.rcsmanager.jar:system/framework/com.motorola.ims.rcsmanager.jar:moto \
    vendor/moto/shamu/proprietary/com.verizon.hardware.telephony.ehrpd.jar:system/framework/com.verizon.hardware.telephony.ehrpd.jar:moto \
    vendor/moto/shamu/proprietary/com.verizon.hardware.telephony.lte.jar:system/framework/com.verizon.hardware.telephony.lte.jar:moto \
    vendor/moto/shamu/proprietary/com.verizon.ims.jar:system/framework/com.verizon.ims.jar:moto \
    vendor/moto/shamu/proprietary/org.simalliance.openmobileapi.jar:system/framework/org.simalliance.openmobileapi.jar:moto \
    vendor/moto/shamu/proprietary/rcsimssettings.jar:system/framework/rcsimssettings.jar:moto \
    vendor/moto/shamu/proprietary/rcsservice.jar:system/framework/rcsservice.jar:moto \
    ...
    vendor/moto/shamu/proprietary/right.boost.ringtone.eq:system/vendor/firmware/right.boost.ringtone.config:moto \
    ...
    vendor/moto/shamu/proprietary/libssd.so:system/vendor/lib/libssd.so:moto \
    ...
    vendor/moto/shamu/proprietary/libwvdrmengine.so:system/vendor/lib/drm/libwvdrmengine.so:moto \
